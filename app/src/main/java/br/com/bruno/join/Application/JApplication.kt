...
class JApplication : Application() {
    ...
    fun showAlert(description: String, type: Int, duration: Int) {
        val toast = Toast(applicationContext)
        val view = LayoutInflater.from(applicationContext).inflate(R.layout.alert_toast, null, false)
        view.descriptionAlert.text = description
        ...
        val color = when(type){
            ...
            ALERT_TYPE_INFO -> R.color.sucess
            else -> R.color.sucess
        }
        ...
        view.rootAlert.setBackgroundResource(border)
        view.srcAlert.setBackgroundResource(resource)
